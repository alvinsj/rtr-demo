...
import { toSha256, toBase64Url, createRandomString, createPKCECodeChallenge } from '../pkce'

describe('createRandomString', () => {
  test('throws error on 0 length', () => {
    expect(() => createRandomString(0)).toThrow('length must be greater than 0')
  })
...
describe('toBase64Url', () => {
  test('throws error on empty array', () => {
    expect(() => toBase64Url([])).toThrow('bytes must not be empty')
  })
